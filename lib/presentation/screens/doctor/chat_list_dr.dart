...
import 'package:vitaguard_app/presentation/screens/doctor/chat_dr_detail.dart';
...
class ChatListDr extends StatefulWidget {
  ...
  const ChatListDr({super.key, this.repository, this.aiChatScreen});
...
class _ChatListDrState extends State<ChatListDr> {
  ...
  List<ChatPreview> get _fallbackDoctorChats {
    return [
      ChatPreview(
        id: '1',
        name: 'Eslam Ahmed',
